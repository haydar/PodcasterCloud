                ...
                <section id="stepOne">
                    <section class="float-left pr-4 col-md-6">
                                <div class="form-group row">
                                        ...
                                        <input type="text" required name="name" class="form-control" name="form-control" id="name" placeholder="Podcast Name">
                                    </div>
                                    <div class="form-group row">
                                        <label for="subtitle">Subtitle</label>
                                        <input type="text" required name="subtitle" class="form-control" name="form-control" id="subtitle" placeholder="Podcast Subtitle">
                                    </div>
                                    <div class="form-group row">

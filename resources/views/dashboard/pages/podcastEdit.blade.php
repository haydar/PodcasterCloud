            ...
            <form action="{{route('podcast.store')}}"  id="updatePodcast" class="pb-0" method="post" enctype="multipart/form-data">
                ...
                <section class="float-right col-md-6">
                    ...
                    <div class="form-group row d-block">
                        ...
                        <br>
                        <img  height="50%" width="50%" class="mx-auto" src="{{Storage::disk('doSpaces')->url('uploads/podcastImages/'.$podcast->artworkImage)}}">
                    </div>
                ...
                <section class="col-md-12 d-inline-block">
                    ...
                    <div class="form-group row float-right">
                        <button type="submit" id="create" class="btn btn-success"><span class="fas fa-check"></span> Update Podcast</button>
                    </div>
                </section>
            </form>
        </div>
